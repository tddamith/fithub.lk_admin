...
from app.api.v1.trainer_auth import router as trainer_auth_router
...
app.include_router(media_uploader_router, prefix="/api/v1", tags=["Media Upload"])
app.include_router(sign_in_router, prefix="/api/v1/auth", tags=["Admin Auth"])
app.include_router(trainers_router, prefix="/api/v1", tags=["Trainers"])
app.include_router(owner_auth_router, prefix="/api/v1/auth/owner", tags=["Owner Auth"])
app.include_router(trainer_auth_router, prefix="/api/v1/auth/trainer", tags=["Trainer Auth"])
app.include_router(user_auth_router, prefix="/api/v1/auth/user", tags=["User Auth"])